...
hasknife= 0 
hasdied=0
hasfoundhiddenroom= 0 
hasreveivedpowerup= 0
...
while haskilledslaughters < 6 and hasdied==0:
	if inRoom == "west":
		...
		if action == 4:
			inRoom="hidden"
			hasfoundhiddenroom= 1
			print "travel to the hidden room"
		

	if inRoom== "hidden": 
		print "you have met Hannibal Lector, he has a question for you; what looses its head in the morning and gets it back at night?"
		...
		if action== 1: 
			hasreveivedpowerup= 1 
			print "your power up killed all the slaughters."
			haskilledslaughters= 6
		if action== 2: 
			haskilledslaughters= 0 
			hasdied= 1		
